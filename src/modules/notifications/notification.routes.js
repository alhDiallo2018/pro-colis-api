...
notificationRouter.post('/email/send-bulk', requireRoles('super_admin'), messagingController.sendBulkEmailMessage);
...
adminNotificationRouter.use(authenticate, requireRoles('super_admin'));
